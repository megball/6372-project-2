...
>>>>>>> 703ac4b87e75e904081c7f856340ff881d8f91af
```
...
#results.rf<-prediction(fitRF.predictions.raw, test$y,label.ordering=c("no","yes"))
#roc.complex = performance(results.complex, measure = "tpr", x.measure = "fpr")
#plot(roc.complex,colorize = TRUE)
#abline(a=0, b= 1)
```
...
<<<<<<< HEAD
#plot(res.roc, col = "green", add = TRUE)
legend("bottomright",legend=c("Stepwise Logistic Regression","Complex Model", "LDA", "Random Forest"),col=c("orange","blue","red"),lty=1,lwd=1)
=======
plot(roc.randomforest, col="purple", add = TRUE)
legend("bottomright",legend=c("Stepwise Logistic Regression","Complex Model", "LDA", "Random Forest"),col=c("orange","blue","red","purple"),lty=1,lwd=1)
>>>>>>> 703ac4b87e75e904081c7f856340ff881d8f91af
abline(a=0, b= 1)
```

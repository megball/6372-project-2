...
```{r}
train %>% dplyr::filter(rownames(train) %in% c("17215","31370","33679","32754","18438","21183")) %>% dplyr::select(y,job,default,contact,month,duration,campaign,previous,cons_price_idx,cons_conf_idx,euribor3m,Age_Grp,prevly_Cntctd,duration_group)
```
